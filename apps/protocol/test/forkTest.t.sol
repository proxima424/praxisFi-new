...
import {SwapExample} from "../src/uniswapHelper/pUNISWAP.sol";
...
contract SwapTester is Test {
    ...
    SwapExample public swapper;

    function setUp() public {
        ethFork = vm.createFork("https://eth.llamarpc.com");
        vm.selectFork(ethFork);
        swapper = new SwapExample(ISwapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564));
    }
